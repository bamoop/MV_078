...
public class CameraCommand {
	...
	private static String COMMAND_VIDEORECORD = "record" ;//记录
	private static String COMMAND_VIDEOCAPTURE = "capture" ;//捕捉图像
	private static String COMMAND_FORMATSDCARD = "formatSD" ;//格式化SD卡
	...
	public static String toasText=null;
				...
				if (pat != null && pat.isEmpty()) {
					if(mToast_success == null){
						mToast_success = Toast.makeText(context,
							context.getResources().getString(R.string.message_command_succeed), Toast.LENGTH_SHORT);
					}
