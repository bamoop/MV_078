...
public class CameraCommand {
	...
	* */
	...
	public static URL commandformatsdcardSettingsUrl() {
		...
		String[] arguments = new String[1] ;
		arguments[0] = buildArgument(PROPERTY_FORMATSDCARD, "formatSD") ;
		return buildRequestUrl(CGI_PATH, ACTION_SET, buildArgumentList(arguments)) ;
	}
	/*恢复出厂设置*/
	...
	public static URL commandGetQualitySettingsUrl() {

		String[] arguments = new String[1] ;
//		arguments[0] = buildArgument(PROPERTY_VIDEORES, "") ;
//		return buildRequestUrl(CGI_PATH, ACTION_GET, buildArgumentList(arguments)) ;
		arguments[0] = buildArgument(PROPERTY_VIDEORES) ;
		return buildRequestUrl(CGI_PATH, ACTION_GET, buildArgumentList(arguments)) ;
	}
	...
	public static URL commandGetTVSYSTEMSettingsUrl() {

		String[] arguments = new String[1] ;
		arguments[0] = buildArgument(PROPERTY_TVSYSTEM, COMMAND_FORMATSDCARD) ;
		return buildRequestUrl(CGI_PATH, ACTION_GET, buildArgumentList(arguments)) ;
	}
	public static URL commandSetTVSYSTEMSettingsUrl(String value) {

		String[] arguments = new String[1] ;
		arguments[0] = buildArgument(PROPERTY_TVSYSTEM, String.valueOf(value)) ;
		return buildRequestUrl(CGI_PATH, ACTION_SET, buildArgumentList(arguments)) ;
	}
