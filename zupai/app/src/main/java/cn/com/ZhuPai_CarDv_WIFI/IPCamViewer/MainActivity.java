...
//				}
	...
	public void isVersion(){
		...
		if(v ==G_UNKNOWN_VERSION)
		{
			...
			M_VERSION = pref.getInt(g_version_check,G_UNKNOWN_VERSION);
...
//				alertDialog.show() ;
			...
			liveStreamUrl = "http://" + gateway + DEFAULT_MJPEG_PUSH_URL ;
//			liveStreamUrl = null;
			if (result != null) {
				String[] lines;
				...
				try {
					...
					switch (av) {
						case 1:	// liveRTSP/av1 for RTSP MJPEG+AAC
							liveStreamUrl = "rtsp://" + gateway + DEFAULT_RTSP_MJPEG_AAC_URL ;
							break;
						case 2: // liveRTSP/v1 for RTSP H.264
							liveStreamUrl = "rtsp://" + gateway + DEFAULT_RTSP_H264_URL ;
							break;
						case 3: // liveRTSP/av2 for RTSP H.264+AAC
							liveStreamUrl = "rtsp://" + gateway + DEFAULT_RTSP_H264_AAC_URL ;
							break;
					}
